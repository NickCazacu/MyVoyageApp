...
/** Экран «Советы» — rule-based рекомендации по рейсу (офлайн, без AI). */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun TipsScreen(
    onBack: () -> Unit,
    viewModel: TipsViewModel = viewModel(factory = TipsViewModel.Factory)
) {
...
private fun TipCard(tip: Tip) {
    // Цвет фона зависит от важности совета.
    ...
    Card(
        ...
        Column(Modifier.padding(16.dp)) {
            Text(tip.title, style = MaterialTheme.typography.titleMedium, color = Color.Unspecified)
